...
class make_edit_point():
    def __init__(self, start_video):
        ...
        self.video_num = [str(i) + " video " for i in range(1,10)]
    ...
    def calculate_time_video(self):
        for period in self.subclip_dir:
            ...
            print("next_video: " + str(self.next_start))
            print("____")
...
a = make_edit_point(0)
a.calculate_time_video()
print(a.return_result())
